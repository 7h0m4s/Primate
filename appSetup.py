...
setup(
    app=['server.py'],
    options=dict(py2app=dict(includes=['views'],packages=['email','werkzeug','pyperclip','jinja2','tendo'],excludes=['pygtk','pyqt','gtk','wx'],argv_emulation=True),plist={'LSUIElement': True})
)
